...
<c:set var="title" value="${msg.tosTitle}" />
<%@ include file="../../header.jsp" %>
<%@ page pageEncoding="UTF-8" %>
<h2>Terms of Service</h2>

<p>The following terms and conditions govern all use of the Welshare
...
operated by Omniverse Ltd. ("Operator"). The Website is offered
...
policies (including, without limitation, Operator's <a href="http://welshare.com/info/privacy">Privacy
Policy</a>)
and procedures that may be published from time to time on this Site by
Operator (collectively, the "Agreement").</p>
...
<li><strong>Your Welshare Account and Site.</strong> If you
create a message stream on the Website, you are responsible for
maintaining the security of your account and message stream, and you
are fully responsible for all activities that occur under the account
and any other actions taken in connection with the message stream. You
must not describe or assign keywords to your message stream in a
...
message stream, comment on a message stream, post material to the
...
<li>the Content is not libelous or defamatory, does not contain threats or incite violence towards
individuals or entities, and does not violate the privacy or publicity
rights of any third party;</li>

<li>your message stream is not getting advertised via unwanted electronic
messages such as spam links on newsgroups, email lists, other message streams
and web sites, and similar unsolicited promotional methods;</li>

<li>your message stream is not named in a manner that misleads your
readers into thinking that you are another person or company. For
example, your message stream's URL or name is not the name of a person other
...
re-distribute the Content under the terms of the <a href="http://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0</a>.</p>
...
available through the websites and webpages to which Welshare
links, and that link to Welshare. Operator does not have any
...
located on or linked to by Welshare violates your copyright, you
...
Welshare, the Welshare logo, and all other trademarks,
service marks, graphics and logos used in connection with
Welshare, or the Website are trademarks or registered trademarks
...
terminate this Agreement or your Welshare account (if you have
...
<p><em>Originally published by Automattic, Inc. as the <a href="http://en.wordpress.com/tos/">WordPress.com Terms
of Service</a> and made available by them under the <a href="http://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-ShareAlike 3.0
License</a>.
Modifications were made by Control Yourself, Inc. and Omniverse Ltd. and made available under the terms of the same license.</em>
